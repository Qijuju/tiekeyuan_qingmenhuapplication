...
public class LocalPhoneDao extends AbstractDao<LocalPhone, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Platformid = new Property(1, String.class, "platformid", false, "PLATFORMID");
        public final static Property Name = new Property(2, String.class, "name", false, "NAME");
        public final static Property Phonenumber = new Property(3, String.class, "phonenumber", false, "PHONENUMBER");
        public final static Property Pinyinname = new Property(4, String.class, "pinyinname", false, "PINYINNAME");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'LOCAL_PHONE' (" + //
                ...
                "'PLATFORMID' TEXT," + // 1: platformid
                "'NAME' TEXT," + // 2: name
                "'PHONENUMBER' TEXT," + // 3: phonenumber
                "'PINYINNAME' TEXT);"); // 4: pinyinname
    }
