...
/** 
 * DAO for table GROUP_CHATS.
*/
public class GroupChatsDao extends AbstractDao<GroupChats, String> {

    public static final String TABLENAME = "GROUP_CHATS";

    /**
     * Properties of entity GroupChats.<br/>
    ...
    */
    ...
    public GroupChatsDao(DaoConfig config) {
        super(config);
    }
    
    public GroupChatsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'GROUP_CHATS'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, GroupChats entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public GroupChats readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, GroupChats entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(GroupChats entity, long rowId) {
        return entity.getId();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(GroupChats entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
