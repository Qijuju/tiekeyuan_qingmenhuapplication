...
exports.sendDocFile = function(messageDetail, objectTP,objectID,filePath, success, error) {//图片上传接口
  exec(success, error, "ThriftApiClient", "sendDocFile", [messageDetail,objectTP,objectID,filePath]);
};
