...
angular.module('message.controllers', [])
  ...
  .controller('MessageCtrl', function ($scope, $http, $state, $mqtt,$formalurlapi, $chatarr, $stateParams, $rootScope, $greendao,$timeout,$contacts,$ToastUtils,$cordovaBarcodeScanner,$location,$api,$ionicPlatform,$ionicHistory,$pubionicloading,$ionicPopup,$cordovaFileOpener2,$ionicPopover) {
