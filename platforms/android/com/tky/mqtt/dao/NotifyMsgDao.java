...
/** 
 * DAO for table NOTIFY_MSG.
*/
public class NotifyMsgDao extends AbstractDao<NotifyMsg, String> {

    public static final String TABLENAME = "NOTIFY_MSG";

    /**
     * Properties of entity NotifyMsg.<br/>
    ...
    */
    ...
    public NotifyMsgDao(DaoConfig config) {
        super(config);
    }
    
    public NotifyMsgDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'NOTIFY_MSG' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'NOTIFY_MSG'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, NotifyMsg entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public NotifyMsg readEntity(Cursor cursor, int offset) {
        NotifyMsg entity = new NotifyMsg( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, NotifyMsg entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(NotifyMsg entity, long rowId) {
        return entity.get_id();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(NotifyMsg entity) {
        if(entity != null) {
            return entity.get_id();
        } else {
            return null;
